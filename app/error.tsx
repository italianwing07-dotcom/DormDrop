  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
      <section className="rounded-[20px] border border-campus-border bg-campus-card p-6 shadow-soft">
        <p className="text-sm font-semibold text-campus-coral">Something went wrong</p>
        <h1 className="mt-2 text-2xl font-bold tracking-tight">DormLoot hit an unexpected error</h1>
